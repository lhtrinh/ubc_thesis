...
mods <- foreach(i=1:100, .errorhandling = "pass", .combine="rbind", .verbose=TRUE) %dopar% {
...
write_csv(mods, "C:/Users/lyhtr/OneDrive - UBC/Thesis/Data/holdout_results_FDR01_100times.csv")

print("Done with running 100 FRD 0.1 without risk factors.")
