...
# postmenopausal
my_df <- full_all %>%
  filter(match_id %in% full_all$match_id[full_all$age_at_diagnosis-full_all$sdc_age_calc<=5]) %>%
...
write_csv(mods, "C:/Users/lyhtr/OneDrive - UBC/Thesis/Data/holdout_5yr_meta_100times.csv")
