...
mods <- foreach(i=1:50, .errorhandling = "pass", .combine="rbind", .verbose=TRUE) %dopar% {
...
write_csv(mods, "C:/Users/lyhtr/OneDrive - UBC/Thesis/Data/holdout_svmr_allmeta_50times_v2.csv")
